...
public class OldCarController : MonoBehaviour
{
    ...
    private float visualMaxSteeringAngle => carSettings.VisualMaxSteeringAngle;
    private AnimationCurve steeringCurve => carSettings.SteeringCurve;
    private float steerLerpSpeed => carSettings.SteerLerpSpeed;
    private float normalWheelFriction => carSettings.NormalWheelFriction;
    private float driftWheelFriction => carSettings.DriftWheelFriction;
    private float maxDriftAngleStart => carSettings.MaxDriftAngleStart;
    private float maxDriftAngleStop => carSettings.MaxDriftAngleStop;
    private float counterDriftStartSpeed => carSettings.CounterDriftStartSpeed;
    private float counterDriftStopSpeed => carSettings.CounterDriftStopSpeed;
    private float maxCounterDriftAngularAccel => carSettings.MaxCounterDriftAngularAccel;
    private float boostForce => carSettings.BoostForce;
    private float maxBoost => carSettings.MaxBoost;
    private float boostRechargeRate => carSettings.BoostRechargeRate;
    private float maxBoostRechargeCooldown => carSettings.MaxBoostRechargeCooldown;
    private float brakePower => carSettings.BrakePower;
    private AnimationCurve torqueCurve => carSettings.TorqueCurve;
    private float maxTorque => carSettings.MaxTorque;
    private float initialAccelleration => carSettings.InitialAccelleration;
    private float initialAccellerationMaxSpeed => carSettings.InitialAccellerationMaxSpeed;
    private float maxSpeed => carSettings.MaxSpeed;
