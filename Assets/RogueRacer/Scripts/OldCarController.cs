...
public class OldCarController : MonoBehaviour
{
    ...
    [SerializeField] private WheelParticles wheelParticles;
    [SerializeField] private GameObject smokePrefab;
    [SerializeField] private BaseCarSettings carSettings;
    private float visualMaxSteeringAngle => carSettings.CarSettings.visualMaxSteeringAngle;
    private AnimationCurve steeringCurve => carSettings.CarSettings.steeringCurve;
    private float steerLerpSpeed => carSettings.CarSettings.steerLerpSpeed;
    private float normalWheelFriction => carSettings.CarSettings.normalWheelFriction;
    private float driftWheelFriction => carSettings.CarSettings.driftWheelFriction;
    private float maxDriftAngleStart => carSettings.CarSettings.maxDriftAngleStart;
    private float maxDriftAngleStop => carSettings.CarSettings.maxDriftAngleStop;
    private float counterDriftStartSpeed => carSettings.CarSettings.counterDriftStartSpeed;
    private float counterDriftStopSpeed => carSettings.CarSettings.counterDriftStopSpeed;
    private float maxCounterDriftAngularAccel => carSettings.CarSettings.maxCounterDriftAngularAccel;
    private float boostForce => carSettings.CarSettings.boostForce;
    private float maxBoost => carSettings.CarSettings.maxBoost;
    private float boostRechargeRate => carSettings.CarSettings.boostRechargeRate;
    private float maxBoostRechargeCooldown => carSettings.CarSettings.maxBoostRechargeCooldown;
    private float brakePower => carSettings.CarSettings.brakePower;
    private AnimationCurve torqueCurve => carSettings.CarSettings.torqueCurve;
    private float maxTorque => carSettings.CarSettings.maxTorque;
    private float initialAccelleration => carSettings.CarSettings.initialAccelleration;
    private float initialAccellerationMaxSpeed => carSettings.CarSettings.initialAccellerationMaxSpeed;
    private float maxSpeed => carSettings.CarSettings.maxSpeed;
